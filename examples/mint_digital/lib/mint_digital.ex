...
defmodule MintDigital do
  ...
  defp setup_genstage(socket) do
    {:ok, producer} = MintDigital.Query.start_link(socket)
    {:ok, producer_consumer} = MintDigital.QueryRateLimiter.start_link(:ok)
    {:ok, consumer} = MintDigital.QueryRunner.start_link(:ok)
